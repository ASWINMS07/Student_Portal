// Central mock academic data for both Admin and Student views
// This file is intended to be imported by frontend components (and can be reused in backend if needed).
